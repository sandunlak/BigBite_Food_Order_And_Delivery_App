...
const register = async (req, res) => {
    try {
        const { name,fullName, email, password,vehicalNo,phone } = req.body;
        ...
        const newUser = new userModel({ name, email,fullName,vehicalNo,phone, password: hashedPassword, photo });
